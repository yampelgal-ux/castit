...
export const CASTINGS: Casting[] = [
  {
    id: "c1",
    title: "תפקיד ראשי — 'אחרי הגשם' (סרט עלילתי)",
    studio: "אולפני צפון-רוח",
    studioLogo: UNSPLASH("1611162617213-7d7a39e9b1d7", 200),
    type: "Feature Film",
    location: "תל אביב + סופיה",
    paid: true,
    deadline: "28 במאי",
    description: "מחפשים שחקנית ראשית, 25-32, שולטת בעברית ואנגלית. דרמה עם אלמנטים של מותחן. 6 שבועות צילום.",
    requirements: {
      gender: ["Female"],
      ageRange: [25, 32],
      languages: ["Hebrew", "English"],
  ...
  {
    id: "c2",
    title: "תפקיד משנה — סדרת Netflix מוגבלת",
    studio: "אולפני יס",
    ...
    paid: true,
    deadline: "3 ביוני",
    description: "דרמת תקופה משנות ה-70. ליהוק ל-3 תפקידי משנה. עדיפות לשחקני אופי חזקים.",
    requirements: {
      ageRange: [28, 55],
      languages: ["Hebrew"],
    },
  ...
  {
    id: "c3",
    title: "ראשי גברי — פרסומת ספורט",
    studio: "אדידס ישראל",
    studioLogo: UNSPLASH("1556906781-9a412961c28c", 200),
    type: "Commercial",
    location: "אילת (יומיים)",
    paid: true,
    deadline: "22 במאי",
    description: "מבנה גוף אתלטי, 22-30. כישורי גלישה או סקייטבורד יתרון משמעותי. תעריף יומי + שימוש.",
    requirements: {
      gender: ["Male"],
      ageRange: [22, 30],
  ...
  },
  {
    ...
    paid: false,
    deadline: "25 במאי",
    description: "מחפשים פנים אקספרסיביות. לא דיבורי. אווירה: מלנכולית, חלומית.",
    requirements: {
      ageRange: [18, 35],
    },
    applicants: 230,
