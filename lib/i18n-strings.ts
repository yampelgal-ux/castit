// Bilingual string dictionary. Keys are dot-namespaced.
// Add new strings here — both languages required.
//
// Lookup is via useT() / translate() in lib/i18n.ts.

export type Entry = { en: string; he: string };
